# Standard 011: Reliable Ingestion (The "Ghost Data" Protocol)

**Status:** Active
**Effective:** 2026-03-21
**Supersedes:** Standard 059
**Original Date:** November 25, 2025
...
*   **Cost:** 6 hours of debugging search logic when ingestion was the root cause.
...
## 5. The Cleanup Protocol (Encoding & Sanitization)
...
## 6. Enhanced Timestamp Assignment (Standard 096)
...
## 11. Relaxed Durability Protocol (Standard 007)
...
- **Standard 007:** PGlite Memory Optimization (§11 adds `relaxedDurability`)
- **Standard 096:** Timestamp Assignment Protocol
- **Standard 109:** Batched Ingestion (large file handling)
- **Standard 110:** Ephemeral Index (disposable architecture)

---

**Introduced:** v4.0.0 (as Standard 059)
**Renumbered:** v4.8.2 (as Standard 011)
